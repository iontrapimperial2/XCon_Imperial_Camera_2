...
df = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\100.txt', header = None)
...
df1 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\200.txt', header = None)
...
df2 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\300.txt', header = None)
...
df3 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\400.txt', header = None)
...
df4 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\500.txt', header = None)
...
df5 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\600.txt', header = None)
...
df6 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\700.txt', header = None)
...
df7 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\800.txt', header = None)
...
df8 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\900.txt', header = None)
...
df9 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_with_noise\2019_08_20\10MHz\1000.txt', header = None)
...
fi = plt.figure('Histogram for Background 10 ms exposure 100 gain 10MHz Readout')
fi.suptitle('Histogram for Background 10 ms exposure 100 gain 10MHz Readout', fontsize=20)
...
fi1 = plt.figure('Histogram for Background 10 ms exposure 200 gain 10MHz Readout')
fi1.suptitle('Histogram for Background 10 ms exposure 200 gain 10MHz Readout', fontsize=20)
axe1 = fi1.add_subplot(111)
x1, bins1, p1 = axe1.hist(a1, density=True, bins = 60, label = '200 Gain')
...
fi2 = plt.figure('Histogram for Background 10 ms exposure 300 gain 10MHz Readout')
fi2.suptitle('Histogram for Background 10 ms exposure 300 gain 10MHz Readout', fontsize=20)
...
fi3 = plt.figure('Histogram for Background 10 ms exposure 400 gain 10MHz Readout')
fi3.suptitle('Histogram for Background 10 ms exposure 400 gain 10MHz Readout', fontsize=20)
axe3 = fi3.add_subplot(111)
x3, bins3, p3 = axe3.hist(b1, density=True, bins = 78, label = '400 Gain')
...
fi4 = plt.figure('Histogram for Background 10 ms exposure 500 gain 10MHz Readout')
fi4.suptitle('Histogram for Background 10 ms exposure 500 gain 10MHz Readout', fontsize=20)
axe4 = fi4.add_subplot(111)
x4, bins4, p4 = axe4.hist(c, density=True, bins = 94, label = '500 Gain')
...
fi5 = plt.figure('Histogram for Background 10 ms exposure 600 gain 10MHz Readout')
fi5.suptitle('Histogram for Background 10 ms exposure 600 gain 10MHz Readout', fontsize=20)
axe5 = fi5.add_subplot(111)
x5, bins5, p5 = axe5.hist(c1, density=True, bins = 90, label = '600 Gain')
...
fi6 = plt.figure('Histogram for Background 10 ms exposure 700 gain 10MHz Readout')
fi6.suptitle('Histogram for Background 10 ms exposure 700 gain 10MHz Readout', fontsize=20)
axe6 = fi6.add_subplot(111)
x6, bins6, p6 = axe6.hist(d, density=True, bins = 134, label = '700 Gain')
...
fi7 = plt.figure('Histogram for Background 10 ms exposure 800 gain 10MHz Readout')
fi7.suptitle('Histogram for Background 10 ms exposure 800 gain 10MHz Readout', fontsize=20)
axe7 = fi7.add_subplot(111)
x7, bins7, p7 = axe7.hist(d1, density=True, bins = 108, label = '800 Gain')
...
fi8 = plt.figure('Histogram for Background 10 ms exposure 900 gain 10MHz Readout')
fi8.suptitle('Histogram for Background 10 ms exposure 900 gain 10MHz Readout', fontsize=20)
axe8 = fi8.add_subplot(111)
x8, bins8, p8 = axe8.hist(e, density=True, bins = 151, label = '900 Gain')
...
fi9 = plt.figure('Histogram for Background 10 ms exposure 1000 gain 10MHz Readout')
fi9.suptitle('Histogram for Background 10 ms exposure 1000 gain 10MHz Readout', fontsize=20)
axe9 = fi9.add_subplot(111)
x9, bins9, p9 = axe9.hist(e1, density=True, bins = 180, label = '1000 Gain')
