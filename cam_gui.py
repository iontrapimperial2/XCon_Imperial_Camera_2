...
class Ui_cam_gui(object):
    def setupUi(self, cam_gui):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(9, -1, 821, 631))
        ...
        font = QtGui.QFont()
        font.setPointSize(11)
        self.lineEdit_read_mode.setFont(font)
        self.lineEdit_read_mode.setObjectName("lineEdit_read_mode")
        self.gridLayout_10.addWidget(self.lineEdit_read_mode, 0, 1, 1, 1)
        ...
        font = QtGui.QFont()
        font.setPointSize(11)
        self.lineEdit_acq_mode.setFont(font)
        self.lineEdit_acq_mode.setObjectName("lineEdit_acq_mode")
        self.gridLayout_9.addWidget(self.lineEdit_acq_mode, 0, 1, 1, 1)
