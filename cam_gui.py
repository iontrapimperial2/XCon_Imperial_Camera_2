...
class Ui_cam_gui(object):
    def setupUi(self, cam_gui):
        ...
        self.label_Photon_Counting = QtWidgets.QLabel(self.groupBox_5)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_Photon_Counting.setFont(font)
        self.label_Photon_Counting.setAlignment(QtCore.Qt.AlignCenter)
        self.label_Photon_Counting.setObjectName("label_Photon_Counting")
        self.gridLayout_10.addWidget(self.label_Photon_Counting, 1, 0, 1, 1)
        ...
        self.pushButton_Photon_Counting_ON = QtWidgets.QPushButton(self.groupBox_5)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.pushButton_Photon_Counting_ON.setFont(font)
        self.pushButton_Photon_Counting_ON.setObjectName("pushButton_Photon_Counting_ON")
        self.gridLayout_10.addWidget(self.pushButton_Photon_Counting_ON, 1, 1, 1, 1)
        self.pushButton_Photon_Counting_OFF = QtWidgets.QPushButton(self.groupBox_5)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.pushButton_Photon_Counting_OFF.setFont(font)
        self.pushButton_Photon_Counting_OFF.setObjectName("pushButton_Photon_Counting_OFF")
        self.gridLayout_10.addWidget(self.pushButton_Photon_Counting_OFF, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.groupBox_10, 10, 4, 1, 3)
        ...
        self.gridLayout.addWidget(self.groupBox_14, 11, 4, 1, 3)
    ...
    def retranslateUi(self, cam_gui):
        ...
        self.label_Photon_Counting.setText(_translate("cam_gui", "Photon Counting OFF"))
        self.label_Read_mode.setText(_translate("cam_gui", "N/A"))
        self.pushButton_Photon_Counting_ON.setText(_translate("cam_gui", "ON"))
        self.pushButton_Photon_Counting_OFF.setText(_translate("cam_gui", "OFF"))
        ...
        self.groupBox_10.setTitle(_translate("cam_gui", "Pre-Amplifer Gain"))
