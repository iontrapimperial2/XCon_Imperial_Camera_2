...
for i in range(1,11,1):
    ...
    for num in range(1,101,1):
        x = list(range(num*5, (100*5), 1))
        y = x +list(range(0, (num-1)*5,1))
        df8 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\CIC_test\with_single_ion\0V_0_5microsec\1000_' + str(i)+'.txt', header = None)
        ...
        df9 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\CIC_test\with_single_ion\2V_0_3microsec\1000_' + str(i)+'.txt', header = None)
...
fi = plt.figure('Bright binned Histogram 0.1 s exposure 1000 gain CIC noise test')
fi.suptitle('Bright binned Histogram (after readout) 0.1 s exposure 1000 gain CIC noise test', fontsize=20)
...
x8, bins8, p8 = axe.hist(e1, density=True, bins = 60, label = '2 V and 0.3 microsec')
...
x9, bins9, p9 = axe.hist(e, density=True, bins = 60, label = '0 V and 0.5 microsec')
