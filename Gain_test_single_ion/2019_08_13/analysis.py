...
for i in range(1,11,1):
    ...
    df = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\binned\100_' + str(i)+'.txt', header = None)
    ...
    df1 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\binned\200_' + str(i)+'.txt', header = None)
    ...
    df2 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\binned\300_' + str(i)+'.txt', header = None)
    ...
    b = b + np.array(df2).ravel().tolist()
    
    df3 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\binned\400_' + str(i)+'.txt', header = None)
    ...
    b1 = b1 + np.array(df3).ravel().tolist()
    
    
    df4 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\binned\500_' + str(i)+'.txt', header = None)
    ...
    c = c + np.array(df4).ravel().tolist()
    
    df5 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\binned\600_' + str(i)+'.txt', header = None)
    ...
    c1 = c1 + np.array(df5).ravel().tolist()

    
    df6 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\binned\700_' + str(i)+'.txt', header = None)
    ...
    d = d + np.array(df6).ravel().tolist()
    
    df7 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\binned\800_' + str(i)+'.txt', header = None)
    ...
    d1 = d1 + np.array(df7).ravel().tolist()
    
    
    
    
    df9 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\binned\1000_' + str(i)+'.txt', header = None)
    ...
    e1 = e1 + np.array(df9).ravel().tolist()
    
    for num in range(1,101,1):
        x = list(range(num*5, (100*5), 1))
        y = x +list(range(0, (num-1)*5,1))
        df8 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\Gain_test_single_ion\2019_08_13\unbinned\1000_' + str(i)+'.txt', header = None)
...
fi = plt.figure('Bright binned Histogram 0.1 s exposure 1000 gain before and after readout comparison')
fi.suptitle('Bright binned Histogram 0.1 s exposure 1000 gain before and after readout comparison', fontsize=20)
...
x8, bins8, p8 = axe.hist(e, density=True, bins = 60, label = 'After Readout')
...
x9, bins9, p9 = axe.hist(e1, density=True, bins = 60, label = 'Before Readout')
