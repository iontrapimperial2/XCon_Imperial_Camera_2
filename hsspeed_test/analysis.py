...
fi = plt.figure('Bright and Dark Histograms 0.1 s exposure 17 Mhz Readout rate')
fi.suptitle('Bright and Dark Histograms 0.1 s exposure 17 Mhz Readout rate', fontsize=20)
axe = fi.add_subplot(111)
x, bins, p = axe.hist(a, density=True, bins = 60, label = 'Bright')
x1, bins1, p1 = axe.hist(a1, density=True, bins = 60, label = 'Dark')
...
#axe.plot(lnspc, fit_function(lnspc,*popt1), 'r', label="200 Gain Gauss Fit")
axe.legend(fontsize = 16)


fi2 = plt.figure('Bright and Dark Histograms 0.1 s exposure 10 Mhz Readout rate')
fi2.suptitle('Bright and Dark Histograms 0.1 s exposure 10 Mhz Readout rate', fontsize=20)
axe2 = fi2.add_subplot(111)
x2, bins2, p2 = axe2.hist(b, density=True, bins = 60, label = 'Bright')
...
x3, bins3, p3 = axe2.hist(b1, density=True, bins = 60, label = 'Dark')
...
fi4 = plt.figure('Bright and Dark Histograms 0.1 s exposure 5 Mhz Readout rate')
fi4.suptitle('Bright and Dark Histograms 0.1 s exposure 5 Mhz Readout rate', fontsize=20)
axe4 = fi4.add_subplot(111)
x4, bins4, p4 = axe4.hist(c, density=True, bins = 60, label = 'Bright')
...
x5, bins5, p5 = axe4.hist(c1, density=True, bins = 60, label = 'Dark')
...
fi6 = plt.figure('Bright and Dark Histograms 0.1 s exposure 1 Mhz Readout rate')
fi6.suptitle('Bright and Dark Histograms 0.1 s exposure 1 Mhz Readout rate', fontsize=20)
axe6 = fi6.add_subplot(111)
x6, bins6, p6 = axe6.hist(d, density=True, bins = 60, label = 'Bright')
...
x7, bins7, p7 = axe6.hist(d1, density=True, bins = 60, label = 'Dark')
