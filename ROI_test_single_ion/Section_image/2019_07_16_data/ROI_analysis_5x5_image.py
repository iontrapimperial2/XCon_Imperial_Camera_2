...
plt.hist(list3[:9], bins = 9)
plt.hist(list6, bins = 9)
...
plt.hist(list15[:9], bins = 9)
plt.hist(list18, bins = 9)
...
plt.hist(list21[:9], bins = 9)
plt.hist(list24, bins = 9)
...
plt.hist(list27[:9], bins = 9)
plt.hist(list30, bins = 9)
...
plt.hist(list33[:9], bins = 9)
plt.hist(list36, bins = 9)
...
plt.hist(list39[:9], bins = 9)
plt.hist(list42, bins = 9)
...
plt.hist(list45[:9], bins = 9)
plt.hist(list48, bins = 9)
