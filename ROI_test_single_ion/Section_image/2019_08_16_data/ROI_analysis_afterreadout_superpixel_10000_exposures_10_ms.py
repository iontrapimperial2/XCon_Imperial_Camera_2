...
#     #7x7
#     df = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\7x7\unbinned\bright\20ms.txt', header = None)
...
# #     #6x6
# #     df2 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\6x6\unbinned\bright\20ms.txt', header = None)
...
# #     #5x5
# #     df4 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\5x5\unbinned\bright\20ms.txt', header = None)
...
# #     #4x4
# #     df6 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\4x4\unbinned\bright\20ms.txt', header = None)
...
# #         #3x3
# #         df8 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\3x3\unbinned\bright\20ms.txt', header = None)
...
#     y = x +list(range(0, (num-1)*7,1))
#     #7x7
#     df1 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\7x7\unbinned\dark\20ms.txt', header = None)
...
# #     y1 = x1 +list(range(0, (num-1)*6,1))
# #     #6x6    
# #     df3 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\6x6\unbinned\dark\20ms.txt', header = None)
...
# #     y2 = x2 +list(range(0, (num-1)*5,1))
# #     #5x5
# #     df5 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\5x5\unbinned\dark\20ms.txt', header = None)
...
# #     y3 = x3 +list(range(0, (num-1)*4,1))
# #     #4x4
# #     df7 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\4x4\unbinned\dark\20ms.txt', header = None)
...
# #     y4 = x4 +list(range(0, (num-1)*3,1))
# #     #3x3
# #     df9 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\3x3\unbinned\dark\20ms.txt', header = None)
...
fi = plt.figure('Histogram for 20 ms Exposure for 7x7 ROI over 2000 Exposures')
fi.suptitle('Bright and Dark Histogram overlap: 20 ms Exposure for 7x7 ROI over 2000 Exposures', fontsize=20)
axe = fi.add_subplot(111)
x, bins, p = axe.hist(a, density=True, bins = 85, label = 'Post-readout Super Pixel Bright Ion')
x1, bins1, p1 = axe.hist(a1, density=True, bins = 60, label = 'Post-readout Super Pixel Dark Ion')
...
# print('probability of misinterpreting bright ion as dark ion at 20 ms exposure for 7x7 ROI: ' + str(Pin))
# print('probability of misinterpreting dark ion as bright ion at 20 ms exposure for 7x7 ROI: ' + str(Pin1))
# =============================================================================


# =============================================================================
# fi1 = plt.figure('Histogram for 20 ms Exposure for 6x6 ROI over 2000 Exposures')
# fi1.suptitle('Bright and Dark Histogram overlap: 20 ms Exposure for 6x6 ROI over 2000 Exposures', fontsize=20)
# axe1 = fi1.add_subplot(111)
# x, bins, p = axe1.hist(b, density=True, bins = 80, label = 'Prereadout Super Pixel Bright Ion')
# x1, bins1, p1 = axe1.hist(b1, density=True, bins = 80, label = 'Prereadout Super Pixel Dark Ion')
...
# #print('probability of misinterpreting bright ion as dark ion at 20 ms exposure for 6x6 ROI: ' + str(Pin))
# #print('probability of misinterpreting dark ion as bright ion at 20 ms exposure for 6x6 ROI: ' + str(Pin1))
# =============================================================================



# =============================================================================
# fi2 = plt.figure('Histogram for 20 ms Exposure for 5x5 ROI over 2000 Exposures')
# fi2.suptitle('Bright and Dark Histogram overlap: 20 ms Exposure for 5x5 ROI over 2000 Exposures', fontsize=20)
# axe2 = fi2.add_subplot(111)
# x, bins, p = axe2.hist(c, density=True, bins = 80, label = 'Post-readout Super Pixel Bright Ion')
# x1, bins1, p1 = axe2.hist(c1, density=True, bins = 50, label = 'Post-readout Super Pixel Dark Ion')
...
# # Pin = stats.norm.cdf(x2,popt[0],popt[1])
# # Pin1 = 1- stats.norm.cdf(x2, popt1[0], popt1[1])#(p_upper1) - (p_lower1)
# # print('probability of misinterpreting bright ion as dark ion at 20 ms exposure for 5x5 ROI: ' + str(Pin))
# # print('probability of misinterpreting dark ion as bright ion at 20 ms exposure for 5x5 ROI: ' + str(Pin1))
# # =============================================================================
# =============================================================================


# =============================================================================
# fi3 =plt.figure('Histogram for 20 ms Exposure for 4x4 ROI over 2000 Exposures')
# fi3.suptitle('Bright and Dark Histogram overlap: 20 ms Exposure for 4x4 ROI over 2000 Exposures', fontsize=20)
# axe3 = fi3.add_subplot(111)
# x, bins, p = axe3.hist(d, density=True, bins = 85, label = 'Prereadout Super Pixel Bright Ion')
# x1, bins1, p1 = axe3.hist(d1, density=True, bins = 85, label = 'Prereadout Super Pixel Dark Ion')
...
# # Pin = stats.norm.cdf(x2,popt[1],popt[2])
# # Pin1 = 1- stats.norm.cdf(x2, popt1[1], popt1[2])#(p_upper1) - (p_lower1)
# # print('probability of misinterpreting bright ion as dark ion at 20 ms exposure for 4x4 ROI: ' + str(Pin))
# # print('probability of misinterpreting dark ion as bright ion at 20 ms exposure for 4x4 ROI: ' + str(Pin1))
# # =============================================================================
# =============================================================================


# =============================================================================
# fi4 = plt.figure('Histogram for 20 ms Exposure for 3x3 ROI over 2000 Exposures')
# fi4.suptitle('Bright and Dark Histogram overlap: 20 ms Exposure for 3x3 ROI over 2000 Exposures', fontsize=20)
# axe4 = fi4.add_subplot(111)
# x, bins, p = axe4.hist(e, density=True, bins = 85, label = 'Post-readout Super Pixel Bright Ion')
# x1, bins1, p1 = axe4.hist(e1, density=True, bins = 85, label = 'Post-readout Super Pixel Dark Ion')
...
# # Pin = stats.norm.cdf(x2,popt[0],popt[1])
# # Pin1 = 1- stats.norm.cdf(x2, popt1[0], popt1[1])#(p_upper1) - (p_lower1)
# # print('probability of misinterpreting bright ion as dark ion at 20 ms exposure for 3x3 ROI: ' + str(Pin))
# # print('probability of misinterpreting dark ion as bright ion at 20 ms exposure for 3x3 ROI: ' + str(Pin1))
# # =============================================================================
# =============================================================================
