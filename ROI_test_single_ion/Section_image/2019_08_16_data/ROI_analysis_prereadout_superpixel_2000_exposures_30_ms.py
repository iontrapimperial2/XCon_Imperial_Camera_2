...
#7x7
df = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\7x7\binned\bright\30ms.txt', header = None)
...
#6x6
df2 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\6x6\binned\bright\30ms.txt', header = None)
...
#5x5
df4 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\5x5\binned\bright\30ms.txt', header = None)
...
#4x4
df6 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\4x4\binned\bright\30ms.txt', header = None)
...
#3x3
df8 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\3x3\binned\bright\30ms.txt', header = None)
...
#7x7
df1 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\7x7\binned\dark\30ms.txt', header = None)
...
#6x6    
df3 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\6x6\binned\dark\30ms.txt', header = None)
...
#5x5
df5 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\5x5\binned\dark\30ms.txt', header = None)
...
#4x4
df7 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\4x4\binned\dark\30ms.txt', header = None)
...
#3x3
df9 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\3x3\binned\dark\30ms.txt', header = None)
...
# =============================================================================
# fi = plt.figure('Histogram for 30 ms Exposure for 7x7 ROI over 2000 Exposures')
# fi.suptitle('Bright and Dark Histogram overlap: 30 ms Exposure for 7x7 ROI over 2000 Exposures', fontsize=20)
# axe = fi.add_subplot(111)
# x, bins, p = axe.hist(a, density=True, bins = 90, label = 'Prereadout Super Pixel Bright Ion')
...
# # print('probability of misinterpreting bright ion as dark ion at 30 ms exposure for 7x7 ROI: ' + str(Pin))
# # print('probability of misinterpreting dark ion as bright ion at 30 ms exposure for 7x7 ROI: ' + str(Pin1))
# # =============================================================================
# axe.legend(fontsize = 16)
# plt.xlabel('Count reading', fontsize=18)
# plt.ylabel('Probability Density', fontsize=18)
...
# =============================================================================
# fi1 = plt.figure('Histogram for 30 ms Exposure for 6x6 ROI over 2000 Exposures')
# fi1.suptitle('Bright and Dark Histogram overlap: 30 ms Exposure for 6x6 ROI over 2000 Exposures', fontsize=20)
...
# #print('probability of misinterpreting bright ion as dark ion at 30 ms exposure for 6x6 ROI: ' + str(Pin))
# #print('probability of misinterpreting dark ion as bright ion at 30 ms exposure for 6x6 ROI: ' + str(Pin1))
# =============================================================================



fi2 = plt.figure('Histogram for 30 ms Exposure for 5x5 ROI over 2000 Exposures')
fi2.suptitle('Bright and Dark Histogram overlap: 30 ms Exposure for 5x5 ROI over 2000 Exposures', fontsize=20)
axe2 = fi2.add_subplot(111)
x, bins, p = axe2.hist(c, density=True, bins = 100, label = 'Prereadout Super Pixel Bright Ion')
x1, bins1, p1 = axe2.hist(c1, density=True, bins = 35, label = 'Prereadout Super Pixel Dark Ion')
...
# Pin = stats.norm.cdf(x2,popt[0],popt[1])
# Pin1 = 1- stats.norm.cdf(x2, popt1[0], popt1[1])#(p_upper1) - (p_lower1)
# print('probability of misinterpreting bright ion as dark ion at 30 ms exposure for 5x5 ROI: ' + str(Pin))
# print('probability of misinterpreting dark ion as bright ion at 30 ms exposure for 5x5 ROI: ' + str(Pin1))
# =============================================================================
axe2.legend(fontsize = 16)
plt.xlabel('Count reading', fontsize=18)
plt.ylabel('Probability Density', fontsize=18)
...
# =============================================================================
# fi3 =plt.figure('Histogram for 30 ms Exposure for 4x4 ROI over 2000 Exposures')
# fi3.suptitle('Bright and Dark Histogram overlap: 30 ms Exposure for 4x4 ROI over 2000 Exposures', fontsize=20)
...
# # Pin = stats.norm.cdf(x2,popt[1],popt[2])
# # Pin1 = 1- stats.norm.cdf(x2, popt1[1], popt1[2])#(p_upper1) - (p_lower1)
# # print('probability of misinterpreting bright ion as dark ion at 30 ms exposure for 4x4 ROI: ' + str(Pin))
# # print('probability of misinterpreting dark ion as bright ion at 30 ms exposure for 4x4 ROI: ' + str(Pin1))
# # =============================================================================
# =============================================================================


# =============================================================================
# fi4 = plt.figure('Histogram for 30 ms Exposure for 3x3 ROI over 2000 Exposures')
# fi4.suptitle('Bright and Dark Histogram overlap: 30 ms Exposure for 3x3 ROI over 2000 Exposures', fontsize=20)
...
# # Pin = stats.norm.cdf(x2,popt[0],popt[1])
# # Pin1 = 1- stats.norm.cdf(x2, popt1[0], popt1[1])#(p_upper1) - (p_lower1)
# # print('probability of misinterpreting bright ion as dark ion at 30 ms exposure for 3x3 ROI: ' + str(Pin))
# # print('probability of misinterpreting dark ion as bright ion at 30 ms exposure for 3x3 ROI: ' + str(Pin1))
# # =============================================================================
# =============================================================================
