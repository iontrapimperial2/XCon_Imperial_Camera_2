...
#7x7
df = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\7x7\binned\bright\40ms.txt', header = None)
...
#6x6
df2 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\6x6\binned\bright\40ms.txt', header = None)
...
#5x5
df4 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\5x5\binned\bright\40ms.txt', header = None)
...
#4x4
df6 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\4x4\binned\bright\40ms.txt', header = None)
...
#3x3
df8 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\3x3\binned\bright\40ms.txt', header = None)
...
#7x7
df1 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\7x7\binned\dark\40ms.txt', header = None)
...
#6x6    
df3 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\6x6\binned\dark\40ms.txt', header = None)
...
#5x5
df5 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\5x5\binned\dark\40ms.txt', header = None)
...
#4x4
df7 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\4x4\binned\dark\40ms.txt', header = None)
...
#3x3
df9 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\3x3\binned\dark\40ms.txt', header = None)
...
# =============================================================================
# fi1 = plt.figure('Histogram for 40 ms Exposure for 6x6 ROI over 2000 Exposures')
# fi1.suptitle('Bright and Dark Histogram overlap: 40 ms Exposure for 6x6 ROI over 2000 Exposures', fontsize=20)
...
# #print('probability of misinterpreting bright ion as dark ion at 40 ms exposure for 6x6 ROI: ' + str(Pin))
# #print('probability of misinterpreting dark ion as bright ion at 40 ms exposure for 6x6 ROI: ' + str(Pin1))
# =============================================================================
...
# # Pin = stats.norm.cdf(x2,popt[0],popt[1])
# # Pin1 = 1- stats.norm.cdf(x2, popt1[0], popt1[1])#(p_upper1) - (p_lower1)
# # print('probability of misinterpreting bright ion as dark ion at 40 ms exposure for 5x5 ROI: ' + str(Pin))
# # print('probability of misinterpreting dark ion as bright ion at 40 ms exposure for 5x5 ROI: ' + str(Pin1))
# # =============================================================================
# axe2.legend(fontsize = 16)
# plt.xlabel('Count reading', fontsize=18)
# plt.ylabel('Probability Density', fontsize=18)
