...
#7x7
df1 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\7x7\binned\dark\10ms.txt', header = None)
...
#6x6    
df3 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\6x6\binned\dark\10ms.txt', header = None)
...
#5x5
df5 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\5x5\binned\dark\10ms.txt', header = None)
...
#4x4
df7 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\4x4\binned\dark\10ms.txt', header = None)
...
#3x3
df9 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_16_data\3x3\binned\dark\10ms.txt', header = None)
...
lnspc = np.linspace(-145, xmax, 10000)
lnspc_ = np.linspace(0, xmax, 10000)
lnspc2 = np.linspace(115, xmax+115, 10000)
...
area4 = integrate.simps(overlap, x=lsp, dx=1, axis=-1, even='avg')
#area4 = np.trapz(overlap, dx=0.04)
z1 = max(z)
...
axe.plot(lnspc_, norm, 'r', label="Prereadout Super Pixel Bright Ion Gaussian fit") # plot it
...
# x1, bins1, p1 = axe2.hist(c1, density=True, bins = 55, label = 'Prereadout Super Pixel Dark Ion')
...
# x1, bins1, p1 = axe3.hist(d1, density=True, bins = 56, label = 'Prereadout Super Pixel Dark Ion')
...
# x1, bins1, p1 = axe4.hist(e1, density=True, bins = 70, label = 'Prereadout Super Pixel Dark Ion')
