...
popt, pcov = curve_fit(fit_function, xdata=binscenters, ydata=x, p0 = [0.002, 40600, 5000])
print(popt) 
...
popt1, pcov1 = curve_fit(fit_function, xdata=binscenters1, ydata=x1, p0 = [0.0016, 1000, 900])
print(popt1)
...
lnspc = np.linspace(xmin, xmax, 10000)
binscenters = np.array([0.5 * (bins[i] + bins[i+1]) for i in range(len(bins)-1)])
popt, pcov = curve_fit(fit_function, xdata=binscenters, ydata=x, p0 = [0.0003, 20200, 3000])
print(popt) 
...
lnspc1 = np.linspace(xmin1, xmax1, 10000)
binscenters1 = np.array([0.5 * (bins1[i] + bins1[i+1]) for i in range(len(bins1)-1)])
popt1, pcov1 = curve_fit(fit_function, xdata=binscenters1, ydata=x1, p0 = [0.005, 500, 300])
print(popt1)
...
lnspc = np.linspace(xmin, xmax, 10000)
binscenters = np.array([0.5 * (bins[i] + bins[i+1]) for i in range(len(bins)-1)])
popt, pcov = curve_fit(fit_function, xdata=binscenters, ydata=x, p0 = [0.0009, 4000, 1000])
print(popt) 
...
lnspc1 = np.linspace(xmin1, xmax1, 10000)
binscenters1 = np.array([0.5 * (bins1[i] + bins1[i+1]) for i in range(len(bins1)-1)])
popt1, pcov1 = curve_fit(fit_function, xdata=binscenters1, ydata=x1, p0 = [0.015, 200, 120])
print(popt1)
...
lnspc = np.linspace(xmin, xmax, 10000)
binscenters = np.array([0.5 * (bins[i] + bins[i+1]) for i in range(len(bins)-1)])
popt, pcov = curve_fit(fit_function, xdata=binscenters, ydata=x, p0 = [0.0011, 2030, 500])
print(popt) 
...
lnspc1 = np.linspace(xmin1, xmax1, 10000)
binscenters1 = np.array([0.5 * (bins1[i] + bins1[i+1]) for i in range(len(bins1)-1)])
popt1, pcov1 = curve_fit(fit_function, xdata=binscenters1, ydata=x1, p0 = [0.017, 160, 32])
print(popt1)
...
lnspc = np.linspace(xmin, xmax, 10000)
binscenters = np.array([0.5 * (bins[i] + bins[i+1]) for i in range(len(bins)-1)])
popt, pcov = curve_fit(fit_function, xdata=binscenters, ydata=x, p0 = [0.0015, 1740, 300])
print(popt) 
...
lnspc1 = np.linspace(xmin1, xmax1, 10000)
binscenters1 = np.array([0.5 * (bins1[i] + bins1[i+1]) for i in range(len(bins1)-1)])
popt1, pcov1 = curve_fit(fit_function, xdata=binscenters1, ydata=x1, p0 = [0.018, 160, 50])
print(popt1)
...
lnspc = np.linspace(xmin, xmax, 10000)
binscenters = np.array([0.5 * (bins[i] + bins[i+1]) for i in range(len(bins)-1)])
popt, pcov = curve_fit(fit_function, xdata=binscenters, ydata=x, p0 = [0.0014, 1300, 400])
print(popt) 
...
lnspc1 = np.linspace(xmin1, xmax1, 10000)
binscenters1 = np.array([0.5 * (bins1[i] + bins1[i+1]) for i in range(len(bins1)-1)])
popt1, pcov1 = curve_fit(fit_function, xdata=binscenters1, ydata=x1, p0 = [0.017, 180, 50])
print(popt1)
...
lnspc = np.linspace(xmin, xmax, 10000)
binscenters = np.array([0.5 * (bins[i] + bins[i+1]) for i in range(len(bins)-1)])
popt, pcov = curve_fit(fit_function, xdata=binscenters, ydata=x, p0 = [0.002, 930, 300])
print(popt) 
...
lnspc1 = np.linspace(xmin1, xmax1, 10000)
binscenters1 = np.array([0.5 * (bins1[i] + bins1[i+1]) for i in range(len(bins1)-1)])
popt1, pcov1 = curve_fit(fit_function, xdata=binscenters1, ydata=x1, p0 = [0.02, 170, 30])
print(popt1)
...
lnspc = np.linspace(xmin, xmax, 10000)
binscenters = np.array([0.5 * (bins[i] + bins[i+1]) for i in range(len(bins)-1)])
popt, pcov = curve_fit(fit_function, xdata=binscenters, ydata=x, p0 = [0.003, 563, 143])
print(popt) 
...
lnspc1 = np.linspace(xmin1, xmax1, 10000)
binscenters1 = np.array([0.5 * (bins1[i] + bins1[i+1]) for i in range(len(bins1)-1)])
popt1, pcov1 = curve_fit(fit_function, xdata=binscenters1, ydata=x1, p0 = [0.032, 155.3, 10.4])
print(popt1)
