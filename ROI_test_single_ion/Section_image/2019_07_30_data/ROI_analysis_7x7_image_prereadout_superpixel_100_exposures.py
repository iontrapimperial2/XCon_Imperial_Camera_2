...
#1 sec
df = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\bright\1s.txt', header = None)
...
df1 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\dark\1s.txt', header = None)
...
#0.5 sec
df2 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\bright\05s.txt', header = None)
...
df3 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\dark\05s.txt', header = None)
...
#0.1 sec
df4 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\bright\01s.txt', header = None)
...
df5 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\dark\01s.txt', header = None)
...
#50 ms
df6 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\bright\50ms.txt', header = None)
...
df7 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\dark\50ms.txt', header = None)
...
#40 ms
df8 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\bright\40ms.txt', header = None)
...
df9 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\dark\40ms.txt', header = None)
...
#30 ms
df10 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\bright\30ms.txt', header = None)
...
df11 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\dark\30ms.txt', header = None)
...
#20 ms
df12 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\bright\20ms.txt', header = None)
...
df13 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\dark\20ms.txt', header = None)
...
#10 ms
df14 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\bright\10ms.txt', header = None)
...
df15 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_07_30_data\7x7\dark\10ms.txt', header = None)
...
fig = plt.figure('Difference Between Mean Bright and Dark Ion Reading vs Exposure Time with 7x7 ROI over 100 Exposures')
fig.suptitle('Difference Between Mean Bright and Dark Ion Reading vs Exposure Time with 7x7 ROI over 100 Exposures', fontsize=20)
...
#Histograms
fi = plt.figure('Histogram for 1 s Exposure for 7x7 ROI over 100 Exposures')
fi.suptitle('Bright and Dark Histogram overlap: 1 s Exposure for 7x7 ROI over 100 Exposures', fontsize=20)
axe = fi.add_subplot(111)
x, bins, p = axe.hist(a, density=True, bins = 50, label = 'Prereadout Super Pixel Bright Ion')
x1, bins1, p1 = axe.hist(a1, density=True, bins = 50, label = 'Prereadout Super Pixel Dark Ion')
...
axe.plot(lnspc, pdf_g, 'r', label="Prereadout Super Pixel Bright Ion Gaussian fit") # plot it
...
axe.plot(lnspc1, pdf_g1, 'g', label="Prereadout Super Pixel Dark Ion Gaussian fit") 
...
fi1 = plt.figure('Histogram for 0.5 s Exposure for 7x7 ROI over 100 Exposures')
fi1.suptitle('Bright and Dark Histogram overlap: 0.5 s Exposure for 7x7 ROI over 100 Exposures', fontsize=20)
axe1 = fi1.add_subplot(111)
x, bins, p = axe1.hist(b, density=True, bins = 50, label = 'Prereadout Super Pixel Bright Ion')
x1, bins1, p1 = axe1.hist(b1, density=True, bins = 50, label = 'Prereadout Super Pixel Dark Ion')
...
pdf_g = stats.norm.pdf(lnspc, m, s) # now get theoretical values in our interval  
axe1.plot(lnspc, pdf_g, 'r', label="Prereadout Super Pixel Bright Ion Gaussian fit") # plot it
...
pdf_g1 = stats.norm.pdf(lnspc1, m1, s1) # now get theoretical values in our interval  
axe1.plot(lnspc1, pdf_g1, 'g', label="Prereadout Super Pixel Dark Ion Gaussian fit") 
...
fi2 = plt.figure('Histogram for 0.1 s Exposure for 7x7 ROI over 100 Exposures')
fi2.suptitle('Bright and Dark Histogram overlap: 0.1 s Exposure for 7x7 ROI over 100 Exposures', fontsize=20)
axe2 = fi2.add_subplot(111)
x, bins, p = axe2.hist(c, density=True, bins = 50, label = 'Prereadout Super Pixel Bright Ion')
x1, bins1, p1 = axe2.hist(c1, density=True, bins = 50, label = 'Prereadout Super Pixel Dark Ion')
...
pdf_g = stats.norm.pdf(lnspc, m, s) # now get theoretical values in our interval  
axe2.plot(lnspc, pdf_g, 'r', label="Prereadout Super Pixel Bright Ion Gaussian fit") # plot it
...
pdf_g1 = stats.norm.pdf(lnspc1, m1, s1) # now get theoretical values in our interval  
axe2.plot(lnspc1, pdf_g1, 'g', label="Prereadout Super Pixel Dark Ion Gaussian fit") 
...
fi3 =plt.figure('Histogram for 50 ms Exposure for 7x7 ROI over 100 Exposures')
fi3.suptitle('Bright and Dark Histogram overlap: 50 ms Exposure for 7x7 ROI over 100 Exposures', fontsize=20)
axe3 = fi3.add_subplot(111)
x, bins, p = axe3.hist(d, density=True, bins = 50, label = 'Prereadout Super Pixel Bright Ion')
x1, bins1, p1 = axe3.hist(d1, density=True, bins = 50, label = 'Prereadout Super Pixel Dark Ion')
...
pdf_g = stats.norm.pdf(lnspc, m, s) # now get theoretical values in our interval  
axe3.plot(lnspc, pdf_g, 'r', label="Prereadout Super Pixel Bright Ion Gaussian fit") # plot it
...
pdf_g1 = stats.norm.pdf(lnspc1, m1, s1) # now get theoretical values in our interval  
axe3.plot(lnspc1, pdf_g1, 'g', label="Prereadout Super Pixel Dark Ion Gaussian fit") 
...
fi4 = plt.figure('Histogram for 40 ms Exposure for 7x7 ROI over 100 Exposures')
fi4.suptitle('Bright and Dark Histogram overlap: 40 ms Exposure for 7x7 ROI over 100 Exposures', fontsize=20)
axe4 = fi4.add_subplot(111)
x, bins, p = axe4.hist(e, density=True, bins = 50, label = 'Prereadout Super Pixel Bright Ion')
...
pdf_g = stats.norm.pdf(lnspc, m, s) # now get theoretical values in our interval  
axe4.plot(lnspc, pdf_g, 'r', label="Prereadout Super Pixel Bright Ion Gaussian fit") # plot it
...
pdf_g1 = stats.norm.pdf(lnspc1, m1, s1) # now get theoretical values in our interval  
axe4.plot(lnspc1, pdf_g1, 'g', label="Prereadout Super Pixel Dark Ion Gaussian fit") 
...
fi5 = plt.figure('Histogram for 30 ms Exposure for 7x7 ROI over 100 Exposures')
fi5.suptitle('Bright and Dark Histogram overlap: 30 ms Exposure for 7x7 ROI over 100 Exposures', fontsize=20)
axe5 = fi5.add_subplot(111)
x, bins, p = axe5.hist(f, density=True, bins = 50, label = 'Prereadout Super Pixel Bright Ion')
x1, bins1, p1 = axe5.hist(f1, density=True, bins = 50, label = 'Prereadout Super Pixel Dark Ion')
...
pdf_g = stats.norm.pdf(lnspc, m, s) # now get theoretical values in our interval  
axe5.plot(lnspc, pdf_g, 'r', label="Prereadout Super Pixel Bright Ion Gaussian fit") # plot it
...
pdf_g1 = stats.norm.pdf(lnspc1, m1, s1) # now get theoretical values in our interval  
axe5.plot(lnspc1, pdf_g1, 'g', label="Prereadout Super Pixel Dark Ion Gaussian fit") 
...
fi6 = plt.figure('Histogram for 20 ms Exposure for 7x7 ROI over 100 Exposures')
fi6.suptitle('Bright and Dark Histogram overlap: 20 ms Exposure for 7x7 ROI over 100 Exposures', fontsize=20)
axe6 = fi6.add_subplot(111)
x, bins, p = axe6.hist(g, density=True, bins = 50, label = 'Prereadout Super Pixel Bright Ion')
x1, bins1, p1 = axe6.hist(g1, density=True, bins = 50, label = 'Prereadout Super Pixel Dark Ion')
...
pdf_g = stats.norm.pdf(lnspc, m, s) # now get theoretical values in our interval  
axe6.plot(lnspc, pdf_g, 'r', label="Prereadout Super Pixel Bright Ion Gaussian fit") # plot it
...
pdf_g1 = stats.norm.pdf(lnspc1, m1, s1) # now get theoretical values in our interval  
axe6.plot(lnspc1, pdf_g1, 'g', label="Prereadout Super Pixel Dark Ion Gaussian fit") 
...
fi7 =plt.figure('Histogram for 10 ms Exposure for 7x7 ROI over 100 Exposures')
fi7.suptitle('Bright and Dark Histogram overlap: 10 ms Exposure for 7x7 ROI over 100 Exposures', fontsize=20)
axe7 = fi7.add_subplot(111)
x, bins, p = axe7.hist(h, density=True, bins = 30, label = 'Prereadout Super Pixel Bright Ion')
x1, bins1, p1 = axe7.hist(h1, density=True, bins = 30, label = 'Prereadout Super Pixel Dark Ion')
...
pdf_g = stats.norm.pdf(lnspc, m, s) # now get theoretical values in our interval  
axe7.plot(lnspc, pdf_g, 'r', label="Prereadout Super Pixel Bright Ion Gaussian fit") # plot it
...
pdf_g1 = stats.norm.pdf(lnspc1, m1, s1) # now get theoretical values in our interval  
axe7.plot(lnspc1, pdf_g1, 'g', label="Prereadout Super Pixel Dark Ion Gaussian fit") 
