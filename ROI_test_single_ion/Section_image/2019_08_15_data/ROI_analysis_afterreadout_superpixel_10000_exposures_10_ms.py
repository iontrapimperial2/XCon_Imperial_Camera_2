...
#         #7x7
#         df = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_15_data\7x7\bright\10ms_' + str(i)+'.txt', header = None)
...
# =============================================================================
#         x1 = list(range(num*6, (1000*6), 1))
#         y1 = x1 +list(range(0, (num-1)*6,1))
#         #6x6
#         df2 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_14_data\6x6\bright\10ms_' + str(i)+'.txt', header = None)
...
# =============================================================================
        ...
        x2 = list(range(num*5, (1000*5), 1))
        y2 = x2 +list(range(0, (num-1)*5,1))
        #5x5
        df4 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_15_data\5x5\bright\10ms_' + str(i)+'.txt', header = None)
...
# =============================================================================
#         x3 = list(range(num*4, (1000*4), 1))
#         y3 = x3 +list(range(0, (num-1)*4,1))
#         #4x4
#         df6 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_14_data\4x4\bright\10ms_' + str(i)+'.txt', header = None)
...
# =============================================================================
#         x4 = list(range(num*3, (1000*3), 1))
#         y4 = x4 +list(range(0, (num-1)*3,1))
#         #3x3
#         df8 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_15_data\3x3\bright\10ms_' + str(i)+'.txt', header = None)
...
for num in range(1,10001,1):
    print(num)
# =============================================================================
#     x = list(range(num*7, (10000*7), 1))
#     y = x +list(range(0, (num-1)*7,1))
#     #7x7
#     df1 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_15_data\7x7\dark\10ms.txt', header = None)
...
# =============================================================================
#     x1 = list(range(num*6, (10000*6), 1))
#     y1 = x1 +list(range(0, (num-1)*6,1))
#     #6x6    
#     df3 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_14_data\6x6\dark\10ms.txt', header = None)
...
# =============================================================================
    ...
    x2 = list(range(num*5, (10000*5), 1))
    y2 = x2 +list(range(0, (num-1)*5,1))
    #5x5
    df5 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_15_data\5x5\dark\10ms.txt', header = None)
...
# =============================================================================
#     x3 = list(range(num*4, (10000*4), 1))
#     y3 = x3 +list(range(0, (num-1)*4,1))
#     #4x4
#     df7 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_14_data\4x4\dark\10ms.txt', header = None)
...
# =============================================================================
#     x4 = list(range(num*3, (10000*3), 1))
#     y4 = x4 +list(range(0, (num-1)*3,1))
#     #3x3
#     df9 = pd.read_csv(r'C:\Users\iontrap\Documents\iontrap\code\python\XCon_Imperial_Camera_2\ROI_test_single_ion\Section_image\2019_08_15_data\3x3\dark\10ms.txt', header = None)
...
x, bins, p = axe.hist(a, density=True, bins = 150, label = 'Post-readout Super Pixel Bright Ion')
x1, bins1, p1 = axe.hist(a1, density=True, bins = 150, label = 'Post-readout Super Pixel Dark Ion')
...
x, bins, p = axe2.hist(c, density=True, bins = 100, label = 'Post-readout Super Pixel Bright Ion')
x1, bins1, p1 = axe2.hist(c1, density=True, bins = 100, label = 'Post-readout Super Pixel Dark Ion')
...
x, bins, p = axe4.hist(e, density=True, bins = 100, label = 'Post-readout Super Pixel Bright Ion')
x1, bins1, p1 = axe4.hist(e1, density=True, bins = 100, label = 'Post-readout Super Pixel Dark Ion')
