...
for num in range(1,101,1):
    ...
    a2 = [df.iat[i,j] for i in l1 for j in l2]
    ...
    a3 = [df1.iat[i,j] for i in l1 for j in l2]
    ...
    b2 = [df2.iat[i,j] for i in l1 for j in l2]
    ...
    b3 = [df3.iat[i,j] for i in l1 for j in l2]
    ...
    c2 = [df4.iat[i,j] for i in l1 for j in l2]
    ...
    c3 = [df5.iat[i,j] for i in l1 for j in l2]
    ...
    d2 = [df6.iat[i,j] for i in l1 for j in l2]
    ...
    d3 = [df7.iat[i,j] for i in l1 for j in l2]
    ...
    e2 = [df8.iat[i,j] for i in l1 for j in l2]
    ...
    e3 = [df9.iat[i,j] for i in l1 for j in l2]
    ...
    f2 = [df10.iat[i,j] for i in l1 for j in l2]
    ...
    f3 = [df11.iat[i,j] for i in l1 for j in l2]
    ...
    g2 = [df12.iat[i,j] for i in l1 for j in l2]
    ...
    g3 = [df13.iat[i,j] for i in l1 for j in l2]
    ...
    h2 = [df14.iat[i,j] for i in l1 for j in l2]
    ...
    h3 = [df15.iat[i,j] for i in l1 for j in l2]
...
x, bins, p = axe7.hist(h, density=True, bins = 50, label = 'Bright Ion')
x1, bins1, p1 = axe7.hist(h1, density=True, bins = 50, label = 'Dark Ion')
