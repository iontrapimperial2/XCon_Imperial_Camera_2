...
for num in range(1,101,1):
    ...
    a2 = df.drop(y)
    a2 = [a2.iat[i,j] for i in l1 for j in l2]
    a.append(sum(a2))
    ...
    a3 = df1.drop(y)
    a3 = [a3.iat[i,j] for i in l1 for j in l2]
    a1.append(sum(a3))
    ...
    b2 = df2.drop(y)
    b2 = [b2.iat[i,j] for i in l1 for j in l2]
    b.append(sum(b2))
    ...
    b3 = df3.drop(y)
    b3 = [b3.iat[i,j] for i in l1 for j in l2]
    b1.append(sum(b3))
    ...
    c2 = df4.drop(y)
    c2 = [c2.iat[i,j] for i in l1 for j in l2]
    c.append(sum(c2))
    ...
    c3 = df5.drop(y)
    c3 = [c3.iat[i,j] for i in l1 for j in l2]
    c1.append(sum(c3))
    ...
    d2 = df6.drop(y)
    d2 = [d2.iat[i,j] for i in l1 for j in l2]
    d.append(sum(d2))
    ...
    d3 = df7.drop(y)
    d3 = [d3.iat[i,j] for i in l1 for j in l2]
    d1.append(sum(d3))
    ...
    e2 = df8.drop(y)
    e2 = [e2.iat[i,j] for i in l1 for j in l2]
    e.append(sum(e2))
    ...
    e3 = df9.drop(y)
    e3 = [e3.iat[i,j] for i in l1 for j in l2]
    e1.append(sum(e3))
    ...
    f2 = df10.drop(y)
    f2 = [f2.iat[i,j] for i in l1 for j in l2]
    f.append(sum(f2))
    ...
    f3 = df11.drop(y)
    f3 = [f3.iat[i,j] for i in l1 for j in l2]
    f1.append(sum(f3))
    ...
    g2 = df12.drop(y)
    g2 = [g2.iat[i,j] for i in l1 for j in l2]
    g.append(sum(g2))
    ...
    g3 = df13.drop(y)
    g3 = [g3.iat[i,j] for i in l1 for j in l2]
    g1.append(sum(g3))
