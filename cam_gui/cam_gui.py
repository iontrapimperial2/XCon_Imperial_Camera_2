...
class Ui_cam_gui(object):
    def setupUi(self, cam_gui):
        ...
        self.pushButton_Exp_Time = QtWidgets.QPushButton(self.gridLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.pushButton_Exp_Time.setFont(font)
        self.pushButton_Exp_Time.setObjectName("pushButton_Exp_Time")
        self.gridLayout.addWidget(self.pushButton_Exp_Time, 4, 4, 1, 1)
    ...
    def retranslateUi(self, cam_gui):
        ...
        self.pushButton_Exp_Time.setText(_translate("cam_gui", "Set"))
